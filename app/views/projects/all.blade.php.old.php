		...
		<table class="table">
			...
			<thead>
				...
				<tr>
					...
					<th>{{trans('project.name_arabic')}}</th>					

					{{-- <th width="15"><span class="glyphicon glyphicon-eye-open action"></span></th> --}}

					<th width="15"><span class="glyphicon glyphicon-tasks action"></span></th>

					<th width="15"><span class="glyphicon glyphicon-plus action"></span></th>
			...
			<tbody>
				...
				@foreach($projects as $project)
					...
					<tr>
						...
						<td><a href="{{URL::route('project.reports', $project->id)}}" title="{{trans('common.view_reports')}}"><span class="glyphicon glyphicon-tasks action"></span></a></td>

						<td><a href="{{URL::route('project.report.add', array(0, $project->id))}}" title="{{trans('common.add_report')}}"><span class="glyphicon glyphicon-plus action"></span></a></td>

		 				<td><a href="{{URL::route('project.save', $project->id)}}" title="{{trans('common.edit')}}"><span class="glyphicon glyphicon-edit action"></span></a></td>

						<td><a href="{{URL::route('project.delete', $project->id)}}" title="{{trans('common.delete')}}" class="delete" data-name="{{$project->name}}"><span class="glyphicon glyphicon-trash action"></span></a></td>
