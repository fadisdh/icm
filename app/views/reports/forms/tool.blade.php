    ...
    <tbody>
      ...
      @if(!empty($tools))
        ...
        @foreach($tools as $tool)
          ...
          <tr {{ $tool->id == $companyTool->id ? 'class="selected"' : '' }}>
            ...
            <td>{{ Config::get('vars/tool_type.en.'. $tool->type)}}</td>
...
<div class="panel panel-default save-form">
    ...
    <div class="panel-heading" role="tab" id="headingTwo">
      ...
      <h4 class="panel-title">
        ...
        <a class="collapsed" data-toggle="collapse" href="#addnew_tool" aria-expanded="true" aria-controls="addnew_tool">
          ...
          {{ $companyTool->id ? '<i class="fa fa-edit"></i> EDIT' : '<i class="fa fa-plus"></i> ADD NEW' }}
    ...
    <div id="addnew_tool" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
      ...
      <div class="panel-body">
        ...
        {{ Form::model($companyTool, array('route' => array('report.tool.save.post', $report->id, $companyTool->id ? $companyTool->id : 0, $companyTool->tool_id), 'class' => 'form-horizontal', 'role' => 'form')) }}
        ...
        <div class="form-group {{ $errors->first('used') ? 'has-error has-feedback' : '' }}">
          ...
          {{ Form::label('used', trans("report.used"), array('class' => 'col-md-2 control-label')) }}
            ...
            <div class="col-md-10">
              ...
              {{ Form::select('used', Config::get('vars/tool_used.en'), $companyTool->used ? $companyTool->used : null, array('class' => 'form-control', 'placeholder' => trans("report.placeholder.used"))) }}
          ...
          <div class="form-group {{ $errors->first('division') ? 'has-error has-feedback' : '' }}">
            ...
            {{ Form::label('division', trans("report.division"), array('class' => 'col-md-2 control-label')) }}
              ...
              <div class="col-md-10">
                ...
                {{ Form::select('division', array(), null, array('id' => 'divisions', 'data-val' => $companyTool->division_id, 'data-url' => URL::route('json.divisions', $report->project_id), 'class' => 'form-control')) }}
          ...
          <div class="form-group {{ $errors->first('section') ? 'has-error has-feedback' : '' }}">
            ...
            {{ Form::label('section', trans("report.section"), array('class' => 'col-md-2 control-label')) }}
              ...
              <div class="col-md-10">
                ...
                {{ Form::select('section', array(0 => 'Fill Division First'), null, array('id' => 'sections', 'data-val' => $companyTool->section_id, 'data-url' => URL::route('json.sections', $report->project_id), 'class' => 'form-control')) }}
          ...
          <div class="form-group {{ $errors->first('item') ? 'has-error has-feedback' : '' }}">
            ...
            {{ Form::label('item', trans("report.item"), array('class' => 'col-md-2 control-label')) }}
              ...
              <div class="col-md-10">
                ...
                {{ Form::select('item', array(0 => 'Fill Section First'), null, array('id' => 'items', 'data-val' => $companyTool->item_id, 'data-url' => URL::route('json.items', $report->project_id), 'class' => 'form-control')) }}
