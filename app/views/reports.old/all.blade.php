...
@section('content')
	...
	<nav class="page-actions container-fluid" class="page-actions">
		<div class="row">
			<div class="title col-md-3"><i class="fa fa-cubes"></i> Reports</div>
			<div class="actions col-md-9">
				<form class="pull-right" role="search">
		      	...
		      	<div class="btns pull-right">
		      		<a href="{{URL::route('project.report.save', array(0, $projectId))}}" class="btn btn-primary"><i class="fa fa-plus"></i> ADD NEW</a>
		      	</div>
			</div>
		</div>
	</nav><!-- .actions -->
